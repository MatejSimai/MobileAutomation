...
public class BedtimePage {
    ...
    public void setBadTime(String hour, String minutes){
    ...
    public void uncheckDays(String day){
        WebElement badtime= driver.findElement(AppiumBy.xpath("//android.widget.CheckBox[@content-desc=\""+day+"\"]"));
        String dayStatus = badtime.getAttribute("checked");
    ...
    public void checkTimes(){
        ...
        String BadTime = bedtime_clock.getAttribute("text");
        String Wakeup = wakeuptime_clock.getAttribute("text");
        if ((Wakeup.contains("7:30")) && (BadTime.contains("10:55"))){
            System.out.println("Badtime was set up correctly, I go to bad at "+BadTime+" o'clock and wake up at "+Wakeup+" o'clock ");
